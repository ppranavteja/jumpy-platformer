...
hero = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . f f f f f f f f f f . . . 
    . . f 9 9 8 9 9 9 8 8 9 9 f . . 
    . f 8 8 8 9 8 8 8 8 8 8 9 9 f . 
    . f d 8 8 d d d d d d d d d f . 
    . f d 8 d d f d d d d f d d f . 
    . f 8 d d d f d d d d f d d f . 
    . . f d d d f d d d d f d d f . 
    . . f d d d d d d d d d d d f . 
    . . f 2 4 2 2 2 4 4 2 2 2 4 f . 
    . . f d d d 2 2 4 4 2 2 d d f . 
    . . f d d f f f 2 2 f f f d f . 
